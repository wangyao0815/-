...
public class SkuManageController {
    ...
    public Result saveSkuInfo(@RequestBody SkuInfo skuInfo){
        // 调用服务层方法
        this.managerService.saveSkuInfo(skuInfo);
        return Result.ok();
    }
    ...
    public Result getskuInfoList(@PathVariable Long page,
       ...
       Page<SkuInfo> skuInfoPage = new Page<>(page, limit);
        //调用服务层
        IPage iPage = this.managerService.getskuInfoList(skuInfoPage,skuInfo);
        //返回数据
    ...
    public Result onSale(@PathVariable Long skuId){
        //调用服务层
        this.managerService.onSale(skuId);
        return Result.ok();
    }
    ...
    public Result cancelSale(@PathVariable Long skuId){
        //调用服务层
        this.managerService.cancelSale(skuId);
        return Result.ok();
    }
}
